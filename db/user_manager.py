...
class UserManager:
    ...
    def add_user(self, email: str, password_hash: str, role: str = 'free') -> bool:
        ...
        try:
            ...
            conn.commit()
            self.log_activity(email, "signup", "User registered successfully.")
            return True
    ...
    def update_password(self, email: str, new_password_hash: str) -> bool:
        ...
        if updated:
            self.log_activity(email, "password_reset", "User password updated.")
        conn.close()
        return updated
    ...
    def set_email_verified(self, email: str, status: bool) -> bool:
        ...
        if updated and status:
            self.log_activity(email, "email_verification", "Email verified.")
        conn.close()
        return updated
    ...
    def log_activity(self, user_email: str, activity_type: str, details: Optional[str] = None):
